  ...
  const professions: Profession[] = [
    {
      title: "科技公司創辦人",
      company: "科技新創",
      taglineTemplate: (_n: string, _c: string) => `以技術驅動創新，在商業藍圖與生活品味之間，追求最完整的人生平衡。`,
    ...
    },
    {
      title: "投資總監",
      company: "私募資產管理",
      taglineTemplate: (_n: string, _c: string) => `以數字讀懂市場，以熱忱感受生活，在理性與感性之間尋找最美的平衡點。`,
    ...
    },
    {
      title: "建設公司董事",
      company: "不動產開發",
      taglineTemplate: (_n: string, _c: string) => `深耕不動產與城市建築，以匠人精神對待工作，以紳士品味對待生活。`,
    ...
    },
    {
      title: "醫療集團院長",
      company: "醫療集團",
      taglineTemplate: (_n: string, _c: string) => `以醫者的嚴謹對待生命，以藝術家的眼光欣賞世界，在忙碌與安靜中都能找到自己的節奏。`,
    ...
    },
    {
      title: "企業策略顧問",
      company: "管理顧問",
      taglineTemplate: (_n: string, _c: string) => `協助各大企業制定長遠布局，私底下是個熱愛生活藝術與人文旅行的深度探索者。`,
